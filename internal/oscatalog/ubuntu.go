...
to run it. Pick the Desktop Experience entry for the same version instead --
same ISO, already downloaded, and it installs the desktop these programs need.
